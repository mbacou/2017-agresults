...
Note that NDVI and NDVI anomaly values should be corrected on the left tail.

```{r res-fews, fig.cap="Distribution of Last Period Bioclimatic Indicators at Household Locations across Nigeria's States and Kenya's Regions."}
...
```{r res-wc, fig.cap="Distribution of Long-Term Precipitation and Temperature Seasonality at Household Locations across States/Regions (1970-2000, percent std. dev.) Source: WorldClim v2."}
