...
**` format(nrow(uga.hh), big.mark=",")` households** are sampled in Uganda. There are **` uga.hh[is.na(m16_5_latitude), .N]`** households missing coordinates. Missing coordinates are imputed using village centroids (shown on the map below in red).
