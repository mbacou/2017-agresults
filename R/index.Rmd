---
title: "Geospatial Characteristics"
...
```{r nga-odd, fig.cap="Households Located outside of their recorded LGA, Nigeria", fig.height=8, fig.width=4}
...
```{r ken-hh, fig.cap="Households Locations across Counties, Kenya", fig.height=6, fig.width=7}
