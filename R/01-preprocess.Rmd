...
Notes on extracting monthly and dekadal cimatic indicators from FEWSNET and WorldClim repositories. In the case of FEWSNET all spatial layers are extracted from **Jan. 2015** to the latest available data point (typically **May or June 2017**). These data extracts may be used to generate summary statistics over specific planting/growing seasons (the effects of biophysical stresses over a typical year is illustrated below).
...
- **FEWSNET/USGS**  
  ...
  Contains RFE^[rfe], PET^[pet], ETa^[eta], NDVI^[ndvi] at different timescales (daily, dekadal, monthly, yearly) and resolutions (usually 1km or lower), and across different regions for Africa.
...
kable(fews[status==T, .(
  ...
  align=c("l", "c", "c", "c", "c"),
  caption="Tally of Indicators and Raster Layers extracted from FEWSNET")
...
```{r fews-et_anom, fig.cap="ET Anomaly (June 2017, percent of median)", fig.width=6, fig.height=3.6}
...
```{r fews-ndvi_anom, fig.cap="NDVI Anomaly (June 2017, percent of median)", fig.width=6, fig.height=3.6}
